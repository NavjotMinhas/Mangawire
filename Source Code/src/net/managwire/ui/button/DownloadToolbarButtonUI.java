 ...
 * @author Thievery
 */
public class DownloadToolbarButtonUI extends BasicButtonUI {
    ...
    private static final Color CENTER_FILL = new Color(0x9ca8b2);
    private static final Color INNER_BORDER_COLOR = Color.GRAY;
    private static final Color OUTER_BORDER_COLOR = Color.LIGHT_GRAY;
